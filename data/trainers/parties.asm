...
; Silph Co. 7F
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, CHARMELEON, 40, UMBREON, 0
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, IVYSAUR, 40, SYLVEON, 0
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, WARTORTLE, 40, LEAFEON, 0
; Route 22
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 47, CHARIZARD, 50, UMBREON, 53, KABUTOPS, 0
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 47, VENUSAUR, 50, SYLVEON, 53, AERODACTYL, 0
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 47, BLASTOISE, 50, LEAFEON, 53, OMASTAR, 0
