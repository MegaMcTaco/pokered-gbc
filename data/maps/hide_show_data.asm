...
Route2HS:
	...
	db ROUTE_2, ROUTE2_SNORLAX,    SHOW
Route4HS:
...
OaksLabHS:
	...
	db OAKS_LAB, OAKSLAB_BULBASAUR_POKE_BALL,  HIDE ; hidden
...
SilphCo1FHS:
	db SILPH_CO_1F, SILPHCO1F_LINK_RECEPTIONIST, SHOW
PowerPlantHS:
