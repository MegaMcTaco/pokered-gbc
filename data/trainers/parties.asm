...
MistyData:
	db $FF, 18, STARYU, 21, STARMIE, 22, CLOYSTER, 25, WARTORTLE, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, PIKACHU, 20, MAGNEMITE, 25, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 28, PARASECT, 30, IVYSAUR, 0

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 37, VENOMOTH, 43, WEEZING, 37, SCYTHER, 0

BlaineData:
	db $FF, 42, GROWLITHE, 40, MAGMAR, 42, RAPIDASH, 45, FLAREON, 47, ARCANINE, 49, NINETALES, 0
