...
Route20_Object:
	...
	warp_event 4,   3, CINNABAR_VOLCANO, 1
	...
	object_event 55, 14, SPRITE_SWIMMER, STAY, RIGHT, TEXT_ROUTE20_SWIMMER4, OPP_TEACHER, 24
	...
	object_event 24, 12, SPRITE_SWIMMER, STAY, DOWN, TEXT_ROUTE20_SWIMMER8, OPP_TEACHER, 16
	object_event 15,  8, SPRITE_SWIMMER, STAY, UP, TEXT_ROUTE20_SWIMMER9, OPP_BEAUTY, 8
; 	object_event  4,  4, SPRITE_BOULDER, STAY, BOULDER_MOVEMENT_BYTE_2, TEXT_VOLCANO_BOULDER
