...
Route12_Object:
	...
	object_event 11, 92, SPRITE_GAMBLER, STAY, LEFT, TEXT_ROUTE12_COOLTRAINER_M, OPP_SAGE, 9
	...
	object_event 14, 35, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROUTE12_TM_PAY_DAY, SUN_STONE
