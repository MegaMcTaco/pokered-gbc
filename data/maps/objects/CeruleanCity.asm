...
CeruleanCity_Object:
	...
	object_event 30,  8, SPRITE_YOUNGSTER, STAY, NONE, TEXT_CERULEANCITY_ROCKET, OPP_COMRADE, 3
...
;	object_event 27, 12, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_CERULEANCITY_GUARD2
