...
MistyData: ; GYM #2 
	db $FF, 18, STARYU, 21, STARMIE, 25, VAPOREON, 22, WARTORTLE, 0
...
LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, SLOWBRO, 56, JYNX, 56, LAPRAS, 55, GLACEON, 0
...
LanceData:
	db $FF, 60, GYARADOS, 55, DRAGONAIR, 60, CHARIZARD, 63, AERODACTYL, 66, DRAGONITE, 0
