...
RockTunnel1F_Object:
	...
	object_event 23,  8, SPRITE_ROCKET, STAY, LEFT, TEXT_ROCKTUNNEL1F_SUPER_NERD, OPP_COMRADE, 27
	object_event 37, 21, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROCKTUNNEL1F_COOLTRAINER_F1, OPP_TEACHER, 17
	object_event 22, 24, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_ROCKTUNNEL1F_COOLTRAINER_F2, OPP_TEACHER, 18
	object_event 32, 24, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROCKTUNNEL1F_COOLTRAINER_F3, OPP_TEACHER, 19
