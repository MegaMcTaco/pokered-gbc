...
; entries correspond to TRADE_FOR_* constants
	...
	db NIDORINO,   KADABRA,   TRADE_DIALOGSET_CASUAL,    "LENIN@@@@@@"
	...
	db CUBONE,     MACHOKE,   TRADE_DIALOGSET_HAPPY,     "MARX@@@@@@@"
	db NINETALES,  HAUNTER,   TRADE_DIALOGSET_CASUAL,    "ENGELS@@@@@"
	db POLIWHIRL,  JYNX,      TRADE_DIALOGSET_EVOLUTION, "SANKARA@@@@"
	db RAICHU,     LICKITUNG, TRADE_DIALOGSET_EVOLUTION, "CHE@@@@@@@@"
	db VENONAT,    FARFETCHD, TRADE_DIALOGSET_HAPPY,     "FIDEL@@@@@@"
	db NIDORINA,   GRAVELER,  TRADE_DIALOGSET_HAPPY,     "TITO@@@@@@@"
