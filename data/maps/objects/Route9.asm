...
Route9_Object:
	...
	def_object_events
	object_event 13, 10, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE9_COOLTRAINER_F1, OPP_TEACHER, 5
	object_event 24,  7, SPRITE_GAMBLER, STAY, LEFT, TEXT_ROUTE9_COOLTRAINER_M1, OPP_SAGE, 7
	object_event 31,  7, SPRITE_GAMBLER, STAY, RIGHT, TEXT_ROUTE9_COOLTRAINER_M2, OPP_SAGE, 8
	object_event 48,  8, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE9_COOLTRAINER_F2, OPP_TEACHER, 6
