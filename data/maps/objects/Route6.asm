...
Route6_Object:
	...
	def_object_events
	object_event 10, 21, SPRITE_GAMBLER, STAY, RIGHT, TEXT_ROUTE6_COOLTRAINER_M1, OPP_SAGE, 4
	object_event 11, 21, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_F1, OPP_TEACHER, 2
	object_event  0, 15, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_ROUTE6_YOUNGSTER1, OPP_BUG_CATCHER, 10
	object_event 11, 31, SPRITE_GAMBLER, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_M2, OPP_SAGE, 5
	object_event 11, 30, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_F2, OPP_TEACHER, 3
	object_event 19, 26, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_ROUTE6_YOUNGSTER2, OPP_BUG_CATCHER, 11
	object_event 17, 14, SPRITE_GUARD, STAY, DOWN, TEXT_ROUTE6_GUARD
