...
;	db $FF, 40, ELECTRODE, 48, ELECTABUZZ, 49, JOLTEON, 50, MAGNETON, 56, RAICHU, 50, PIKACHU, 0

ErikaData: ; GYM #4
	db $FF, 29, VICTREEBEL, 27, LEAFEON, 29, VILEPLUME, 29, BELLOSSOM, 30, IVYSAUR, 0
;	db $FF, 40, VICTREEBEL, 39, LEAFEON, 37, VILEPLUME, 36, BELLOSSOM, 42, VENUSSAUR, 43, EXEGGUTOR, 0
