...
MistyData: ; GYM #2 
	db $FF, 18, STARYU, 21, STARMIE, 22, VAPOREON, 25, WARTORTLE, 0

LtSurgeData: ; GYM #6
	db $FF, 33, ELECTRODE, 39, ELECTABUZZ, 37, JOLTEON, 35, MAGNETON, 40, RAICHU, 0

ErikaData: ; GYM #4
	db $FF, 29, VICTREEBEL, 27, LEAFEON, 29, VILEPLUME, 28, PARASECT, 30, IVYSAUR, 0
...
Green2Data:
; SS Anne 2F -
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, NINETALES, 40, SYLVEON, 0
...
; Route 22
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 55, NINETALES, 50, SYLVEON, 53, KABUTOPS, 0 ;MEGANIUM
