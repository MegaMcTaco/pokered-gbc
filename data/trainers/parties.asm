...
; Viridian Gym
	db $FF, 45, RHYHORN, 42, DUGTRIO, 44, NIDOQUEEN, 45, NIDOKING, 47, MAROWAK, 50, RHYDON, 0
...
MistyData:
	db $FF, 18, STARYU, 21, STARMIE, 22, CLOYSTER, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, PIKACHU, 20, MAGNEMITE, 24, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 28, PARASECT, 0

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 37, VENOMOTH, 43, WEEZING, 0

BlaineData:
	db $FF, 42, GROWLITHE, 40, MAGMAR, 42, RAPIDASH, 47, ARCANINE, 49, NINETALES, 0

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, HYPNO, 36, SLOWBRO, 43, ALAKAZAM, 0
...
; SS Anne 2F
	...
	db $FF, 19, SPEAROW, 16, POLIWAG, 18, GASTLY, 20, EEVEE, 0
; Pokémon Tower 2F
	db $FF, 25, FEAROW, 25, POLIWHIRL, 25, HAUNTER, 20, SQUIRTLE, 25, EEVEE, 0
	db $FF, 25, FEAROW, 25, POLIWHIRL, 25, HAUNTER, 20, BULBASAUR, 25, EEVEE, 0
	db $FF, 25, FEAROW, 25, POLIWHIRL, 25, HAUNTER, 20, CHARMANDER, 25, EEVEE, 0
; Silph Co. 7F
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, WARTORTLE, 40, LEAFEON, 0
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, IVYSAUR, 40, FLAREON, 0
	db $FF, 37, FEAROW, 38, POLIWHIRL, 35, HAUNTER, 35, CHARMELEON, 40, JOLTEON, 0
; Route 22
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 47, BLASTOISE, 50, LEAFEON, 53, AERODACTYL, 0
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 47, IVYSAUR, 50, FLAREON, 53, KABUTOPS, 0
	db $FF, 47, FEAROW, 45, POLIWRATH, 45, GENGAR, 47, CHARIZARD, 50, JOLTEON, 53, OMASTAR, 0

Green3Data: ;Make RED Champion
	db $FF, 61, PIKACHU, 59, EEVEE, 61, SNORLAX, 61, VENUSAUR, 63, CHARIZARD, 65, BLASTOISE, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, GYARADOS, 63, FLAREON, 65, VENUSAUR, 0
	db $FF, 61, PIDGEOT, 59, ALAKAZAM, 61, RHYDON, 61, EXEGGUTOR, 63, VAPOREON, 65, CHARIZARD, 0
