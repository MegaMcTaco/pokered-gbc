MapSongBanks::
	...
	db MUSIC_ROUTES3, BANK(Music_Routes3) ; SOUTH_CELADON
	...
	db MUSIC_CITIES1, BANK(Music_Cities1) ; ROUTE 26
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; CINNABAR VOLCANO
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; CINNABAR VOLCANO
	db MUSIC_CITIES1, BANK(Music_Cities1) ; LIGHTHOUSE
	db MUSIC_CELADON, BANK(Music_Celadon) ; TRADE_CENTER
	db MUSIC_CELADON, BANK(Music_Celadon) ; COLOSSEUM
	db MUSIC_CITIES1, BANK(Music_Cities1) ; SOUTH CELADON GATE
